  ...
  private void dataGridStyleInitializer() {
    dataGridStyle = new com.google.gwt.user.cellview.client.DataGrid.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GBG2FFLDHG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";}.GBG2FFLDIG{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:") + (("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";}.GBG2FFLDBG{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBG2FFLDFH{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBG2FFLDFH:hover{color:" + ("#6c6b6b")  + ";}.GBG2FFLDCG{background:" + ("#fff")  + ";}.GBG2FFLDDG{border:" + ("2px"+ " " +"solid"+ " " +"#fff") ) + (";}.GBG2FFLDBH{background:" + ("#f3f7fb")  + ";}.GBG2FFLDCH{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GBG2FFLDJG{background:" + ("#eee")  + ";}.GBG2FFLDKG{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBG2FFLDMG{background:" + ("#ffc")  + ";}.GBG2FFLDNG{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBG2FFLDDH{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBG2FFLDEH{border:") + (("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBG2FFLDLG{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}")) : ((".GBG2FFLDHG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";}.GBG2FFLDIG{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:") + (("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";}.GBG2FFLDBG{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GBG2FFLDFH{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBG2FFLDFH:hover{color:" + ("#6c6b6b")  + ";}.GBG2FFLDCG{background:" + ("#fff")  + ";}.GBG2FFLDDG{border:" + ("2px"+ " " +"solid"+ " " +"#fff") ) + (";}.GBG2FFLDBH{background:" + ("#f3f7fb")  + ";}.GBG2FFLDCH{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GBG2FFLDJG{background:" + ("#eee")  + ";}.GBG2FFLDKG{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GBG2FFLDMG{background:" + ("#ffc")  + ";}.GBG2FFLDNG{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GBG2FFLDDH{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GBG2FFLDEH{border:") + (("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GBG2FFLDLG{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}"));
      }
