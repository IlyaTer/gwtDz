  ...
  private void nativeVerticalScrollbarUiInitializer() {
    nativeVerticalScrollbarUi = new com.google.gwt.user.client.ui.NativeVerticalScrollbar.UiStyle() {
      ...
      public String getText() {
        return (".GBG2FFLDDI{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";direction:" + ("ltr")  + ";}.GBG2FFLDCI{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";height:" + ("100%")  + ";width:" + ("100px")  + ";overflow-y:" + ("scroll")  + ";overflow-x:" + ("hidden")  + ";}");
      }
