  ...
  private void nativeVerticalScrollbarStyleInitializer() {
    nativeVerticalScrollbarStyle = new com.google.gwt.user.client.ui.NativeVerticalScrollbar.Style() {
      ...
      public String getText() {
        return (".GBG2FFLDAI{opacity:" + ("0.7")  + ";filter:" + ("alpha(opacity = 70)")  + ";-webkit-transition:" + ("opacity"+ " " +"350ms")  + ";-moz-transition:" + ("opacity"+ " " +"350ms")  + ";-o-transition:" + ("opacity"+ " " +"350ms")  + ";transition:" + ("opacity"+ " " +"350ms")  + ";}.GBG2FFLDAI:hover{opacity:" + ("1")  + ";filter:" + ("alpha(opacity = 100)")  + ";}");
      }
